...
const galleryImages = [
  "/figmaAssets/rectangle-1-7.webp",
  "/figmaAssets/rectangle-2-2.webp",
  "/figmaAssets/rectangle-3-3.webp",
  "/figmaAssets/rectangle-4-4.webp",
  "/figmaAssets/rectangle-5.webp",
];
                ...
                >
                  {column.map((link) => (
                    <Button
                      ...
                      type="button"
                      variant="ghost"
                      data-testid={`footer-social-${link.label.toLowerCase().replace(' ', '-')}`}
                      className={`h-auto gap-2.5 p-0 ${bodyTextClassName} transition-colors hover:bg-transparent hover:text-primary-systembeige focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-systemivory focus-visible:ring-offset-2 focus-visible:ring-offset-primary-systemcoal`}
                    >
                      <img
