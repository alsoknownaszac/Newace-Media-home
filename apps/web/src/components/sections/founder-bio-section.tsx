...
export function FounderBioSection() {
  return (
    <section
      ...
      className="flex w-full scroll-mt-24 items-start justify-center gap-3 bg-primary-systemivory p-3 sm:gap-6 sm:p-6 lg:gap-[58px] lg:p-[100px]"
    >
      <Image
      ...
      <article className="flex min-w-0 flex-1 flex-col items-start justify-center gap-3 sm:gap-5 lg:w-[604px] lg:flex-none lg:gap-7">
        ...
        <div className="flex flex-col gap-2 font-web-body-s text-xs font-[number:var(--web-body-s-font-weight)] leading-[var(--web-body-s-line-height)] tracking-[var(--web-body-s-letter-spacing)] text-primary-systemcoal sm:gap-3 sm:text-sm lg:gap-2 lg:text-[length:var(--web-body-s-font-size)] [font-style:var(--web-body-s-font-style)]">
          ...
          <p>
            ...
            <strong className="font-semibold">{founderBio.closing.emphasis}</strong>
          </p>
        </div>

        <Button
          asChild
          className="h-auto rounded-none bg-primary-systemcoal px-5 py-2 font-web-label-s text-xs font-[number:var(--web-label-s-font-weight)] leading-[var(--web-label-s-line-height)] tracking-[var(--web-label-s-letter-spacing)] text-primary-systemivory transition-colors hover:bg-primary-systemcoal/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 sm:px-8 sm:py-3 lg:h-11 lg:px-8 lg:py-4 lg:text-[length:var(--web-label-s-font-size)] [font-style:var(--web-label-s-font-style)]"
        >
