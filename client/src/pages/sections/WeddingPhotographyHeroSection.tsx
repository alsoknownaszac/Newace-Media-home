...
export const WeddingPhotographyHeroSection = (): JSX.Element => {
  return (
    <section className="flex w-full flex-col bg-[#f5f2ec]">
      <div
        className="h-[760px] w-full bg-cover bg-center bg-no-repeat [background-image:url(..//figmaAssets/heroimage.png)]"
        role="img"
