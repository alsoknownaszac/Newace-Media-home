...
export const CoupleTestimonialsSection = (): JSX.Element => {
  return (
    <section className="flex w-full items-start justify-center gap-3 bg-primary-systemivory p-3 sm:gap-6 sm:p-6 lg:gap-[58px] lg:p-[100px]">
      <img
        className="w-[35%] self-stretch object-cover sm:w-[38%] lg:w-[432px]"
        alt="Rectangle"
        src="/figmaAssets/rectangle-1-5.png"
      />
      <article className="flex min-w-0 flex-1 flex-col items-start justify-center gap-3 sm:gap-5 lg:w-[604px] lg:flex-none lg:gap-7">
        ...
        <Button
          type="button"
          className="h-auto rounded-none bg-primary-systemcoal px-3 py-1.5 font-web-label-s text-[6px] font-[number:var(--web-label-s-font-weight)] leading-[var(--web-label-s-line-height)] tracking-[var(--web-label-s-letter-spacing)] text-primary-systemivory hover:bg-primary-systemcoal sm:px-5 sm:py-2 sm:text-[10px] lg:h-11 lg:px-8 lg:py-4 lg:text-[length:var(--web-label-s-font-size)]"
        >
          LEARN MORE
        </Button>
      </article>
