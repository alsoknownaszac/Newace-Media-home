...
const testimonial = {
  ...
  image: "/figmaAssets/rectangle-1-4.png",
  ...
  return (
    ...
    >
      ...
      <div className="grid h-[76px] w-full grid-cols-1 grid-rows-1 md:h-[600px]">
        ...
        <div
          aria-hidden="true"
          className="col-start-1 row-start-1 z-20 h-[60px] w-[60px] self-center bg-cover bg-center md:mt-[100px] md:h-[400px] md:w-[400px] md:self-start"
          style={{ backgroundImage: `url(${testimonial.image})` }}
        >
          <div className="h-full w-full bg-[#00000033]" />
        </div>
        <img
